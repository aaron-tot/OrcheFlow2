 ...
 * @todo Split into:
 *   - app/server.ts (server setup)
 *   - app/middleware.ts (middleware stack)
 *   - app/routes.ts (route mounting)
 */
...
// import { LSP } from "../features/cli/infrastructure/lsp" // DISABLED: Web-only, no LSP
import { Format } from "../shared/utils/format"
// import { TuiRoutes } from "../features/cli/infrastructure/tuiRoutes" // DISABLED: Web-only, no TUI
...
import { Command } from "../features/cli/services/command"
...
// import { PtyRoutes } from "../features/cli/infrastructure/pty/ptyRoutes" // DISABLED: Web-only, no PTY
  ...
  export const App: () => Hono = lazy(
    () =>
      ...
      app
        ...
        // .route("/pty", PtyRoutes()) // DISABLED: Web-only, no PTY support
        ...
        .route("/", FileRoutes())
        .route("/mcp", McpRoutes())
        // .route("/tui", TuiRoutes()) // DISABLED: Web-only, no TUI support
        .post(
          "/instance/dispose",
          describeRoute({
        ...
        // DISABLED: LSP not available in web-only mode
        // .get(
        //   "/lsp",
        //   describeRoute({
