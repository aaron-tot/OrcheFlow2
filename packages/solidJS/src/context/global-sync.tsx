...
function createGlobalSync() {
  ...
  async function loadSessions(directory: string) {
    ...
    if (!globalSDK.client.session?.list) {
      console.warn('[GlobalSync] SDK session.list not available')
      return
    }
  ...
  async function bootstrapInstance(directory: string) {
    ...
    const promise = (async () => {
      ...
      if (!sdk.project?.current || !sdk.provider?.list) {
        console.warn('[GlobalSync] SDK project/provider methods not available')
  ...
  async function bootstrap() {
    // Check if SDK has global.health method
    if (!globalSDK.client.global?.health) {
      console.warn('[GlobalSync] SDK global.health not available')
