...
for (const file of files) {
  ...
  // Replace the wrong filesystem import with the correct path to shared/utils/filesystem
  content = content.replace(
    /from ["'][^"']*features\/files\/domain\/filesystem["']/g,
    `from "${correctPrefix}shared/utils/filesystem"`
  );
